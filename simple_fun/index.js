...
function seatsInTheater(nCols, nRows, col, row) {
  //coding and coding..
    ...
    console.log("numeber of cols ", nCols,"\n",
    "Numver of rows: ", nRows,"\n",
    "current colum: ", col,"\n",
    "current row: ", row)

    let audience = nRows - row

    let location = nCols - (col - 1)

    let shyness = audience * location

    console.log("audience: ", audience, "location: ", location, "Shyness: ", shyness)
