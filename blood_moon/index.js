...
function bloodMoon(r){
  // your code here
  console.log("radius: ", r, r*r/4)
  return r*r/4;
}

// Sample Tests:
//
// Test.assertApproxEquals(bloodMoon(0), 0);
// Test.assertApproxEquals(bloodMoon(1), 0.25);
// Test.assertApproxEquals(bloodMoon(2), 1);
// Test.assertApproxEquals(bloodMoon(3), 2.25);
